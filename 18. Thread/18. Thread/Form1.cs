...
namespace _18Thread
{
    public partial class Form1 : Form
    {
        ...
        private void ShowText(string strLabel, string strText)
        {
            ...
            {
                case "label1":
                    label1.Text = strText; break;

                case "label2":
                    label2.Text = strText; break;

                case "label3":
                    label3.Text = strText; break;
            }
        }
        ...
        private void brnStop_Click(object sender, EventArgs e)
        {
        ...
        private void ThreadPlus()
        {
            lock (this)
            {
                while (m_nPlusCount < 1000)
                {
                    ...
                    Thread.Sleep(1);
                    m_nValue = nValue;
                    Invoke(DelegateShowTextInstance, new object[] { "label1", Convert.ToString(nValue) });
